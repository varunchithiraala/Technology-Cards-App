...
const App = () => (
  <div className="technology-cards-container">
    <div className="technology-cards-list-container">
      <h1 className="technology-cards-heading">Learn 4.0 Technologies</h1>
      <p className="technology-cards-description">
      ...
      <ul className="technology-cards-list">
        {cardsList.map(eachCardList => (
          <CardItem cardItemDetails={eachCardList} key={eachCardList.id} />
        ))}
      </ul>
    </div>
  </div>
